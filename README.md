...
[Предварительный просмотр данных.](/project_data.csv) 
...
Сопоставив [график плотности](/Database/Images/unemployment.png) и таблицу, видно, что среднее значение и медиана колеблются в пределах 6%. 
