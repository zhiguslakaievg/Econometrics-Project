...
Таким образом выглядят наши данные: \
Data \ оставь картинку
...
Poverty Rate \ ссылка вниз

Средний зафиксированный за весь период наблюдения уровень бедности по всем штатам показывает неплохие - относительно мировых - значения. По графику плотности (ссылку) можно заметить, что уровень бедности падает с каждым годом, что несомненно служит хорошим показателем экономической эффективности штата. Тем не менее, стоит упомянуть и крайне высокие значения, близкие к 0,25. Эти показатели были зафиксированы в начале десятых годов (2012 и 2013). Сложно однозначно сказать, что послужило причиной подобных выбросов.  
#### Переменная UR.
...
Unemployment Rate \ вниз

Сопоставив график плотности (ссылка) и таблицу, видно, что среднее значение и медиана колеблются около 5% уровня безработицы. Кроме того, можно заметить, что показателей выше 11% довольно мало, по сравнению с остальными.  
...
По графику (ссылка) плотности очевидно, что некоторые значения сильно выбиваются по значению ВВП в большую сторону. Чтобы понять, как именно выглядит выброс, мы изучили эту часть графика (ссылка) ближе и выяснили, что выбивается в большей степени штат Калифорнии.  \
Real GDP Distribution \ вверх
California Data Description \ вниз

Этот штат отличается от других тем, что реальный ВВП с 2010 по 2019 год было выше 2000000, а у остальных штатов значительно ниже (таблица). Нельзя назвать это выбросом данных, так как все значения принадлежат одному штату за все года, то есть это реально возможные значения.  
