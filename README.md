...
Мы взяли данные за 2010-2019 года, за 2020 не брали в целом, так как некоторые из необходимых наблюдений будут известны лишь к концу 2021 - началу 2022 года из-за особенностей сбора статистики в отдельных штатах.  
...
Средний зафиксированный за весь период наблюдения уровень бедности по всем штатам показывает неплохие - относительно мировых - значения. По [графику плотности](/Database/Images/poverty.png) можно заметить, что уровень бедности падает с каждым годом, что несомненно служит хорошим показателем экономической эффективности штата.

#### Переменная UR.
![Unemployment Rate Description](/Database/Images/ur_desc.png)\
Unemployment rate - уровень безработицы в штатах в долях. Значения колеблются от 2,2% до 13,7%. Сопоставив [график плотности](/Database/Images/unemployment.png) и таблицу, видно, что среднее значение и медиана колеблются в пределах 5%. Кроме того, можно заметить, что показателей выше 11% довольно мало по сравнению с остальными.  

Также видно, что в среднем в Соединенных Штатах Америки сохраняется достаточно низкий уровень безработицы, что может указывать на эффективность работы служб занятости и наличии свободных рабочих мест.
...
```
где **Vcrime** - зависимая переменная; **Poverty Rate, Unemployment Rate, Income per Capita, Real GDP** - объясняющие переменные; **β0, β1, β2, β3, β4** - коэффициенты регрессии
...
[Полноценные результаты регрессионного анализа](/Database/Images/regress_res.jpg) 
